...
- **3030 KB** generated bundle (2133 lines)
<!-- DIOGNOSIS_STATS_END -->
...
GitHub Pages live testing uses `npm run pages:check`; tagged releases and clinical-review milestones use the deeper `npm run release:check`.
