...
function renderReviewSummary() {
  ...
  const v1SourceContext = findings.filter(finding => finding.evidenceLadder?.sourceLinked || (finding.evidenceRefs || []).length || finding.reviewRequired !== false);
  ...
  <div class="review-summary-grid">
    ...
    ${renderReviewSummaryTile(v1SourceContext.length, "V1 Source Context", "Source-linked or modeled rows available for traceable review.")}
