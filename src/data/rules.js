// Diognosis — Clinical rule configuration
...
const HIGH_IMPACT_METABOLITE_RELATIONS = [
  ...
  { parent:"Pimozide", metaboliteId:"5-hydroxypimozide", metaboliteName:"5-Hydroxypimozide", enzyme:"CYP2D6/CYP3A4", note:"Inactive clearance metabolite; genotype/inhibition signal is parent pimozide accumulation and QT risk.", evidenceRefs:["ev_phase1_high_priority_metabolite_labels","ev_phase4_genotype_metabolite_expansion"], requiredEvidenceRefs:["ev_phase1_high_priority_metabolite_labels","ev_phase4_genotype_metabolite_expansion"] },
  { parent:"Ticlopidine", metaboliteId:"ticlopidine-active-thiol", metaboliteName:"Ticlopidine active thiol metabolite", enzyme:"CYP2C19/CYP2B6", note:"Active irreversible P2Y12 thiol metabolite; lower formation may reduce antiplatelet effect while parent safety risks remain.", evidenceRefs:["ev_phase1_high_priority_metabolite_labels","ev_batch_hemostasis_labels","ev_phase4_genotype_metabolite_expansion"], requiredEvidenceRefs:["ev_phase1_high_priority_metabolite_labels","ev_batch_hemostasis_labels","ev_phase4_genotype_metabolite_expansion"] },
  { parent:"Abrocitinib", metaboliteId:"abrocitinib-m1", metaboliteName:"Abrocitinib M1", enzyme:"CYP2C19/CYP2C9", note:"Active metabolite in combined active exposure; genotype/inhibitor context changes active-moiety balance.", evidenceRefs:["ev_phase1_high_priority_metabolite_labels","ev_batch_kinase_cyp3a_qt_labels","ev_phase4_genotype_metabolite_expansion"], requiredEvidenceRefs:["ev_phase1_high_priority_metabolite_labels","ev_batch_kinase_cyp3a_qt_labels","ev_phase4_genotype_metabolite_expansion"] },
  { parent:"Abrocitinib", metaboliteId:"abrocitinib-m2", metaboliteName:"Abrocitinib M2", enzyme:"CYP2C19/CYP2C9", note:"Active metabolite contributing materially to combined exposure.", evidenceRefs:["ev_phase1_high_priority_metabolite_labels","ev_batch_kinase_cyp3a_qt_labels","ev_phase4_genotype_metabolite_expansion"], requiredEvidenceRefs:["ev_phase1_high_priority_metabolite_labels","ev_batch_kinase_cyp3a_qt_labels","ev_phase4_genotype_metabolite_expansion"] },
  { parent:"Acalabrutinib", metaboliteId:"acp-5862", metaboliteName:"ACP-5862", enzyme:"CYP3A4/CYP3A5", note:"Major active BTK metabolite; CYP3A modifiers change active moiety exposure.", evidenceRefs:["ev_phase1_high_priority_metabolite_labels","ev_batch_kinase_cyp3a_qt_labels","ev_phase4_genotype_metabolite_expansion"], requiredEvidenceRefs:["ev_phase1_high_priority_metabolite_labels","ev_batch_kinase_cyp3a_qt_labels","ev_phase4_genotype_metabolite_expansion"] },
  { parent:"Acenocoumarol", metaboliteId:"6-hydroxyacenocoumarol", metaboliteName:"6-Hydroxyacenocoumarol", enzyme:"CYP2C9", note:"Inactive clearance metabolite; CYP2C9 reduced function raises parent VKA exposure/INR sensitivity.", evidenceRefs:["ev_phase1_high_priority_metabolite_labels","ev_warfarin_cyp2c9_vkorc1_cyp4f2_cpic2017","ev_phase4_genotype_metabolite_expansion"], requiredEvidenceRefs:["ev_phase1_high_priority_metabolite_labels","ev_warfarin_cyp2c9_vkorc1_cyp4f2_cpic2017","ev_phase4_genotype_metabolite_expansion"] },
  { parent:"Lapatinib", metaboliteId:"lapatinib-quinone-imine", metaboliteName:"Lapatinib reactive quinone-imine context", enzyme:"CYP3A4/CYP3A5", note:"Reactive metabolite context for hepatic-risk stacking, not a calibrated genotype dose rule.", evidenceRefs:["ev_phase1_high_priority_metabolite_labels","ev_batch_kinase_cyp3a_qt_labels","ev_phase4_genotype_metabolite_expansion"], requiredEvidenceRefs:["ev_phase1_high_priority_metabolite_labels","ev_batch_kinase_cyp3a_qt_labels","ev_phase4_genotype_metabolite_expansion"] },
  { parent:"Busulfan", metaboliteId:"busulfan-glutathione-conjugate", metaboliteName:"Busulfan glutathione conjugate", enzyme:"GSTA1/GSTM1/GSTT1", note:"GST-mediated clearance context; reduced GST function raises the importance of TDM and conditioning toxicity review.", evidenceRefs:["ev_busulfan_gst_meta","ev_phase4_genotype_metabolite_expansion"], requiredEvidenceRefs:["ev_busulfan_gst_meta","ev_phase4_genotype_metabolite_expansion"] },
  { parent:"Diazepam", metaboliteId:"nordiazepam-desmethyldiazepam", metaboliteName:"Nordiazepam", enzyme:"CYP2C19", note:"Long-lived active metabolite; CYP2C19 poor function shifts clearance and prolonged sedation context.", evidenceRefs:["ev_phase4_genotype_metabolite_expansion"], requiredEvidenceRefs:["ev_phase4_genotype_metabolite_expansion"] },
  { parent:"Ketamine", metaboliteId:"dehydronorketamine-dhnk", metaboliteName:"Dehydronorketamine (DHNK)", enzyme:"CYP2B6", note:"Active longer-lived metabolite; CYP2B6 context can shift dissociative/antidepressant metabolite balance.", evidenceRefs:["ev_phase4_genotype_metabolite_expansion"], requiredEvidenceRefs:["ev_phase4_genotype_metabolite_expansion"] },
  { parent:"Cannabis (THC)", metaboliteId:"11-hydroxy-thc-11-oh-thc", metaboliteName:"11-Hydroxy-THC", enzyme:"CYP2C9", note:"Active oral THC metabolite; CYP2C9 reduced function can shift THC/11-OH-THC exposure balance.", evidenceRefs:["ev_phase4_genotype_metabolite_expansion"], requiredEvidenceRefs:["ev_phase4_genotype_metabolite_expansion"] },
  { parent:"Cannabis (CBD)", metaboliteId:"7-hydroxy-cbd-7-oh-cbd", metaboliteName:"7-Hydroxy-CBD", enzyme:"CYP2C19", note:"Active CBD metabolite and CYP2C19 inhibition context; genotype, dose, and co-medications determine net signal.", evidenceRefs:["ev_phase4_genotype_metabolite_expansion"], requiredEvidenceRefs:["ev_phase4_genotype_metabolite_expansion"] },
];
...
const GENOTYPE_METABOLITE_EFFECTS = [
  ...
  },
  {
    ...
    enzyme:"ABCB1",
    systemic:true,
    note:"Digoxin is a narrow-therapeutic-index P-gp substrate. ABCB1 genotype associations are inconsistent, so Diognosis treats reduced P-gp function as a conservative exposure-monitoring context rather than a fixed dose rule.",
  ...
  {
    parent:"Pimozide",
    metaboliteId:"5-hydroxypimozide",
    metaboliteName:"5-Hydroxypimozide",
    enzyme:"CYP2D6",
    systemic:true,
    note:"Pimozide's genotype-relevant signal is not an active metabolite gain; reduced CYP2D6 lowers inactive hydroxylated clearance while parent pimozide exposure and QT risk rise. CYP3A inhibitors and QT stacks remain decisive.",
    evidenceRefs:["ev_phase1_high_priority_metabolite_labels","ev_phase4_genotype_metabolite_expansion"],
    inhibitionDirection:"increase",
    inhibitionLabel:"CYP2D6 poor function/inhibition: parent pimozide exposure and QT-risk context increase",
    clinicalAction:"review ECG/electrolytes, QT co-medications, CYP3A/CYP2D6 inhibitors, and label dosing limits",
    effects:{
      [GENOTYPE_PHENOTYPE.PM]: { qualitative:true, direction:"increase", label:"parent pimozide accumulation/QT risk context; inactive metabolite formation falls" },
      [GENOTYPE_PHENOTYPE.IM]: { qualitative:true, direction:"increase", label:"partial clearance reduction; QT and inhibitor stack review needed" },
      [GENOTYPE_PHENOTYPE.NM]: { fold:1.0, direction:"baseline", label:"baseline CYP2D6 clearance context" },
    }
  },
  {
    parent:"Ticlopidine",
    metaboliteId:"ticlopidine-active-thiol",
    metaboliteName:"Ticlopidine active thiol metabolite",
    enzyme:"CYP2C19",
    note:"Ticlopidine activation to an irreversible P2Y12-inhibiting thiol is partly CYP2C19-linked. Poor function may reduce active-thiol formation, but parent-label marrow toxicity, bleeding, and CYP2C19/CYP2B6 inhibition remain clinically important.",
    ...
    inhibitionDirection:"decrease",
    inhibitionLabel:"CYP2C19 poor function/inhibition: lower active thiol formation possible",
    clinicalAction:"interpret with platelet indication, bleeding/procedure timing, marrow toxicity, and alternative P2Y12 options",
    effects:{
      [GENOTYPE_PHENOTYPE.PM]: { qualitative:true, direction:"decrease", label:"active thiol formation may be lower; antiplatelet response could be reduced" },
      [GENOTYPE_PHENOTYPE.IM]: { qualitative:true, direction:"decrease", label:"partial active-thiol reduction possible" },
      [GENOTYPE_PHENOTYPE.NM]: { fold:1.0, direction:"baseline", label:"baseline active-thiol formation context" },
      [GENOTYPE_PHENOTYPE.UM]: { qualitative:true, direction:"increase", label:"higher activation possible; bleeding and marrow toxicity still label-guided" },
    }
  },
  {
    parent:"Ticlopidine",
    ...
    metaboliteName:"Ticlopidine active thiol metabolite",
    enzyme:"CYP2B6",
    note:"CYP2B6 also contributes to ticlopidine activation/intermediate formation. The effect is included as a review flag because clinical actionability is weaker than for clopidogrel CYP2C19 guidance.",
    evidenceRefs:["ev_phase1_high_priority_metabolite_labels","ev_batch_hemostasis_labels","ev_phase4_genotype_metabolite_expansion"],
    inhibitionDirection:"decrease",
    inhibitionLabel:"CYP2B6 reduced function: possible lower active-thiol formation",
    effects:{
      [GENOTYPE_PHENOTYPE.PM]: { qualitative:true, direction:"decrease", label:"possible lower active-thiol formation; clinical significance uncertain" },
      [GENOTYPE_PHENOTYPE.IM]: { qualitative:true, direction:"decrease", label:"possible partial activation reduction" },
      [GENOTYPE_PHENOTYPE.NM]: { fold:1.0, direction:"baseline", label:"baseline CYP2B6 contribution" },
    }
  },
  {
    parent:"Abrocitinib",
    metaboliteId:"abrocitinib-m2",
    metaboliteName:"Abrocitinib active moiety (M1/M2)",
    enzyme:"CYP2C19",
    systemic:true,
    note:"Abrocitinib parent plus active metabolites M1/M2 form a combined active moiety. CYP2C19 reduced function or inhibition can change both parent and active-metabolite balance; infection, thrombosis, cytopenia, renal function, and dose limits dominate management.",
    ...
    inhibitionDirection:"increase",
    inhibitionLabel:"CYP2C19 poor function/inhibition: combined active exposure may rise while metabolite balance shifts",
    clinicalAction:"review dose limits, renal function, infection/thrombosis/cytopenia risk, and CYP2C19/CYP2C9 inhibitor overlap",
    effects:{
      [GENOTYPE_PHENOTYPE.PM]: { qualitative:true, direction:"increase", label:"active-moiety exposure may rise; M1/M2 balance shifts" },
      [GENOTYPE_PHENOTYPE.IM]: { qualitative:true, direction:"increase", label:"possible active-moiety increase; monitor tolerability" },
      [GENOTYPE_PHENOTYPE.NM]: { fold:1.0, direction:"baseline", label:"baseline active-moiety context" },
      [GENOTYPE_PHENOTYPE.UM]: { qualitative:true, direction:"decrease", label:"possibly lower parent/active-moiety exposure; response context matters" },
    }
  },
  {
    parent:"Abrocitinib",
    metaboliteId:"abrocitinib-m1",
    metaboliteName:"Abrocitinib active moiety (M1/M2)",
    enzyme:"CYP2C9",
    systemic:true,
    note:"CYP2C9 contributes to abrocitinib active-moiety metabolism with CYP2C19. Reduced function is a contextual active-exposure flag, especially when combined with CYP2C19 poor function or inhibitors.",
    evidenceRefs:["ev_phase1_high_priority_metabolite_labels","ev_batch_kinase_cyp3a_qt_labels","ev_phase4_genotype_metabolite_expansion"],
    inhibitionDirection:"increase",
    inhibitionLabel:"CYP2C9 reduced function/inhibition: active-moiety exposure may rise",
    effects:{
      [GENOTYPE_PHENOTYPE.PM]: { qualitative:true, direction:"increase", label:"possible active-moiety increase; strongest if CYP2C19 is also reduced/inhibited" },
      [GENOTYPE_PHENOTYPE.IM]: { qualitative:true, direction:"increase", label:"modest active-moiety shift possible" },
      [GENOTYPE_PHENOTYPE.NM]: { fold:1.0, direction:"baseline", label:"baseline CYP2C9 contribution" },
    }
  },
  {
    parent:"Acalabrutinib",
    metaboliteId:"acp-5862",
    metaboliteName:"ACP-5862",
    enzyme:"CYP3A4",
    note:"ACP-5862 is an active BTK metabolite. CYP3A inhibition or reduced CYP3A context can raise parent and metabolite exposure, while strong induction can lower active moiety exposure.",
    evidenceRefs:["ev_phase1_high_priority_metabolite_labels","ev_batch_kinase_cyp3a_qt_labels","ev_phase4_genotype_metabolite_expansion"],
    inhibitionDirection:"increase",
    inhibitionLabel:"CYP3A inhibition/reduced activity: active BTK moiety exposure may rise",
    effects:{
      [GENOTYPE_PHENOTYPE.PM]: { qualitative:true, direction:"increase", label:"higher parent/ACP-5862 exposure context possible; CYP3A inhibitor stack matters more" },
      [GENOTYPE_PHENOTYPE.IM]: { qualitative:true, direction:"increase", label:"possible modest active-moiety increase" },
      [GENOTYPE_PHENOTYPE.NM]: { fold:1.0, direction:"baseline", label:"baseline CYP3A active-moiety context" },
      [GENOTYPE_PHENOTYPE.UM]: { qualitative:true, direction:"decrease", label:"possible lower active moiety exposure; strong inducers dominate" },
    }
  },
  {
    parent:"Acenocoumarol",
    metaboliteId:"6-hydroxyacenocoumarol",
    metaboliteName:"6-Hydroxyacenocoumarol",
    enzyme:"CYP2C9",
    systemic:true,
    note:"Acenocoumarol is a vitamin K antagonist cleared substantially through CYP2C9 hydroxylation. Reduced CYP2C9 function lowers inactive metabolite formation and can raise parent anticoagulant exposure; INR-guided dosing remains mandatory.",
    evidenceRefs:["ev_phase1_high_priority_metabolite_labels","ev_batch_hemostasis_labels","ev_warfarin_cyp2c9_vkorc1_cyp4f2_cpic2017","ev_phase4_genotype_metabolite_expansion"],
    inhibitionDirection:"increase",
    inhibitionLabel:"CYP2C9 reduced function/inhibition: parent VKA exposure and INR sensitivity may increase",
    clinicalAction:"use INR monitoring and local anticoagulation protocol; review bleeding, age, diet, inhibitors, and VKORC1/CYP4F2 context",
    effects:{
      [GENOTYPE_PHENOTYPE.PM]: { qualitative:true, direction:"increase", label:"parent acenocoumarol exposure/INR sensitivity may rise; inactive 6-OH formation falls" },
      [GENOTYPE_PHENOTYPE.IM]: { qualitative:true, direction:"increase", label:"moderate parent-exposure/INR sensitivity signal" },
      [GENOTYPE_PHENOTYPE.NM]: { fold:1.0, direction:"baseline", label:"baseline CYP2C9 hydroxylation context" },
    }
  },
  {
    parent:"Lapatinib",
    metaboliteId:"lapatinib-quinone-imine",
    metaboliteName:"Lapatinib reactive quinone-imine context",
    enzyme:"CYP3A4",
    systemic:true,
    note:"Lapatinib CYP3A bioactivation can create reactive quinone-imine context, but hepatotoxicity is not a calibrated genotype dose rule. Treat reduced CYP3A clearance, CYP3A inhibition, hepatic impairment, and GST detoxification burden as a risk stack.",
    evidenceRefs:["ev_phase1_high_priority_metabolite_labels","ev_batch_kinase_cyp3a_qt_labels","ev_phase4_genotype_metabolite_expansion"],
    inhibitionDirection:"increase",
    inhibitionLabel:"CYP3A inhibition/reduced activity: parent exposure rises; reactive-metabolite hepatic context should be reviewed",
    clinicalAction:"review hepatic labs, CYP3A inhibitors/inducers, QT stack, diarrhea/dehydration, and oncology protocol",
    effects:{
      [GENOTYPE_PHENOTYPE.PM]: { qualitative:true, direction:"increase", label:"higher parent exposure/hepatic risk-stack context; reactive-metabolite interpretation is qualitative" },
      [GENOTYPE_PHENOTYPE.IM]: { qualitative:true, direction:"increase", label:"possible hepatic risk-stack signal" },
      [GENOTYPE_PHENOTYPE.NM]: { fold:1.0, direction:"baseline", label:"baseline CYP3A hepatic context" },
      [GENOTYPE_PHENOTYPE.UM]: { qualitative:true, direction:"uncertain", label:"parent exposure may be lower, but induction and hepatic monitoring remain central" },
    }
  },
  {
    parent:"Busulfan",
    metaboliteId:"busulfan-glutathione-conjugate",
    metaboliteName:"Busulfan glutathione conjugate",
    enzyme:"GSTA1",
    systemic:true,
    note:"GSTA1 is a major busulfan glutathione-conjugation route. Reduced GSTA1 expression/activity can lower clearance and raise exposure/toxicity risk, but busulfan therapeutic drug monitoring and conditioning protocol dosing must override genotype-only inference.",
    evidenceRefs:["ev_busulfan_gst_meta","ev_phase1_high_priority_metabolite_labels","ev_phase4_genotype_metabolite_expansion"],
    inhibitionDirection:"increase",
    inhibitionLabel:"GSTA1 reduced function: lower busulfan clearance / higher exposure context",
    clinicalAction:"prioritize busulfan TDM, seizure prophylaxis, hepatic/VOD risk, regimen protocol, and interacting anticonvulsants/azole context",
    effects:{
      [GENOTYPE_PHENOTYPE.PM]: { qualitative:true, direction:"increase", label:"reduced GSTA1 clearance context; busulfan AUC/toxicity monitoring high priority" },
      [GENOTYPE_PHENOTYPE.IM]: { qualitative:true, direction:"increase", label:"possible lower clearance; use TDM/protocol" },
      [GENOTYPE_PHENOTYPE.NM]: { fold:1.0, direction:"baseline", label:"baseline GSTA1 clearance context" },
    }
  },
  {
    parent:"Diazepam",
    metaboliteId:"nordiazepam-desmethyldiazepam",
    metaboliteName:"Nordiazepam",
    enzyme:"CYP2C19",
    note:"Diazepam produces long-lived active metabolites including nordiazepam and oxazepam. CYP2C19 poor function can prolong parent/active-moiety exposure; age, hepatic function, co-sedatives, and falls risk dominate interpretation.",
    evidenceRefs:["ev_phase4_genotype_metabolite_expansion"],
    inhibitionDirection:"increase",
    inhibitionLabel:"CYP2C19 poor function/inhibition: diazepam active-moiety persistence may increase",
    effects:{
      [GENOTYPE_PHENOTYPE.PM]: { qualitative:true, direction:"increase", label:"prolonged parent/active-metabolite sedation context" },
      [GENOTYPE_PHENOTYPE.IM]: { qualitative:true, direction:"increase", label:"possible prolonged active-moiety exposure" },
      [GENOTYPE_PHENOTYPE.NM]: { fold:1.0, direction:"baseline", label:"baseline active-metabolite persistence" },
      [GENOTYPE_PHENOTYPE.UM]: { qualitative:true, direction:"decrease", label:"possibly shorter persistence; clinical sedation response still dominates" },
    }
  },
  {
    parent:"Ketamine",
    metaboliteId:"dehydronorketamine-dhnk",
    metaboliteName:"Dehydronorketamine (DHNK)",
    enzyme:"CYP2B6",
    note:"Ketamine metabolite balance includes norketamine and dehydronorketamine. CYP2B6 reduced function can shift parent/metabolite exposure, but route, dose, setting, dissociation, blood pressure, substance co-use, and psychiatric protocol dominate.",
    evidenceRefs:["ev_phase4_genotype_metabolite_expansion"],
    inhibitionDirection:"uncertain",
    inhibitionLabel:"CYP2B6 reduced function: ketamine metabolite balance may shift",
    effects:{
      [GENOTYPE_PHENOTYPE.PM]: { qualitative:true, direction:"uncertain", label:"parent/metabolite balance may shift; monitor sedation, dissociation, BP, and protocol response" },
      [GENOTYPE_PHENOTYPE.IM]: { qualitative:true, direction:"uncertain", label:"possible intermediate metabolite-balance shift" },
      [GENOTYPE_PHENOTYPE.NM]: { fold:1.0, direction:"baseline", label:"baseline CYP2B6 contribution" },
    }
  },
  {
    parent:"Cannabis (THC)",
    metaboliteId:"11-hydroxy-thc-11-oh-thc",
    metaboliteName:"11-Hydroxy-THC",
    enzyme:"CYP2C9",
    note:"11-Hydroxy-THC is an active metabolite, especially relevant after oral THC. CYP2C9 reduced function can alter parent THC and 11-OH-THC balance; dose, formulation, route, tolerance, and co-sedatives dominate safety.",
    evidenceRefs:["ev_phase4_genotype_metabolite_expansion"],
    inhibitionDirection:"uncertain",
    inhibitionLabel:"CYP2C9 reduced function: THC/11-OH-THC balance may shift",
    effects:{
      [GENOTYPE_PHENOTYPE.PM]: { qualitative:true, direction:"uncertain", label:"THC and active-metabolite balance may shift; oral products deserve extra caution" },
      [GENOTYPE_PHENOTYPE.IM]: { qualitative:true, direction:"uncertain", label:"possible intermediate exposure-balance shift" },
      [GENOTYPE_PHENOTYPE.NM]: { fold:1.0, direction:"baseline", label:"baseline CYP2C9 THC context" },
    }
  },
  {
    parent:"Cannabis (CBD)",
    metaboliteId:"7-hydroxy-cbd-7-oh-cbd",
    metaboliteName:"7-Hydroxy-CBD",
    enzyme:"CYP2C19",
    note:"7-Hydroxy-CBD is active and CBD can inhibit CYP2C19. CYP2C19 poor function or inhibitors can shift active metabolite and parent CBD exposure; antiseizure co-therapy, liver enzymes, dose, and sedation/GI effects dominate.",
    evidenceRefs:["ev_phase4_genotype_metabolite_expansion"],
    inhibitionDirection:"increase",
    inhibitionLabel:"CYP2C19 poor function/inhibition: CBD active-moiety and DDI context may increase",
    effects:{
      [GENOTYPE_PHENOTYPE.PM]: { qualitative:true, direction:"increase", label:"higher CBD/CYP2C19 interaction context; active metabolite balance may shift" },
      [GENOTYPE_PHENOTYPE.IM]: { qualitative:true, direction:"increase", label:"possible active-moiety/DDI context increase" },
      [GENOTYPE_PHENOTYPE.NM]: { fold:1.0, direction:"baseline", label:"baseline CBD CYP2C19 context" },
      [GENOTYPE_PHENOTYPE.UM]: { qualitative:true, direction:"decrease", label:"possibly lower active metabolite exposure; formulation/dose dominate" },
    }
  },
];
