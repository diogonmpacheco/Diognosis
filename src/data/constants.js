// Diognosis — Shared constants and enums
...
const GENOTYPE_EFFECTS = {
  ...
  UGT2B17: {
    [GENOTYPE_PHENOTYPE.PM]:  { auc_fold:1.5, freq_pct:null, note:"UGT2B17 deletion/low-function context. Effects are substrate-specific and often strongest for androgen/steroid glucuronidation; Diognosis uses it as a caution flag for oxazepam/temazepam-like glucuronidation rather than a dose rule." },
  ...
  "G6PD deficiency": {
    ...
    drugEffects:[
      ...
      },
      {
        ...
        phenotype:"acute hemolytic anemia",
        note:"CPIC classifies nitrofurantoin as medium risk in G6PD deficiency: use standard doses with caution and close monitoring for anemia.",
        clinicalAction:"use with caution and close anemia monitoring in known G6PD deficiency",
        evidenceRefs:["ev_g6pd_cpic2022_expanded"],
      },
      {
        parent:"Tafenoquine",
        phenotype:"acute hemolytic anemia / methemoglobinemia",
    ...
    effects:{
      ...
      [GENOTYPE_RISK_STATUS.PRESENT]: { label:"G6PD deficient", severity:"high", note:"G6PD deficiency present. Drug-specific risk tiers apply; CPIC low-to-no-risk drugs should not be avoided on this marker alone." },
    },
  },
  "MT-RNR1 m.1555A>G": {
    gene:"MT-RNR1",
    ...
    drugEffects:[
      ...
      },
      {
        parent:"Dibekacin",
        phenotype:"irreversible aminoglycoside ototoxicity",
        note:"MT-RNR1 risk variants markedly increase aminoglycoside ototoxicity risk, including with dibekacin.",
        clinicalAction:"avoid aminoglycosides unless the severity of infection and lack of safe or effective alternatives outweigh permanent hearing-loss risk",
        evidenceRefs:["ev_aminoglycoside_mtrnr1_cpic2021"],
      },
      {
        parent:"Kanamycin",
        phenotype:"irreversible aminoglycoside ototoxicity",
        note:"MT-RNR1 risk variants markedly increase aminoglycoside ototoxicity risk, including with kanamycin.",
        clinicalAction:"avoid aminoglycosides unless the severity of infection and lack of safe or effective alternatives outweigh permanent hearing-loss risk",
        evidenceRefs:["ev_aminoglycoside_mtrnr1_cpic2021"],
      },
      {
        parent:"Neomycin",
        phenotype:"irreversible aminoglycoside ototoxicity",
        note:"MT-RNR1 risk variants markedly increase aminoglycoside ototoxicity risk, including with neomycin.",
        clinicalAction:"avoid aminoglycosides unless the severity of infection and lack of safe or effective alternatives outweigh permanent hearing-loss risk",
        evidenceRefs:["ev_aminoglycoside_mtrnr1_cpic2021"],
      },
      {
        parent:"Netilmicin",
        phenotype:"irreversible aminoglycoside ototoxicity",
        note:"MT-RNR1 risk variants markedly increase aminoglycoside ototoxicity risk, including with netilmicin.",
        clinicalAction:"avoid aminoglycosides unless the severity of infection and lack of safe or effective alternatives outweigh permanent hearing-loss risk",
        evidenceRefs:["ev_aminoglycoside_mtrnr1_cpic2021"],
      },
      {
        parent:"Paromomycin",
        phenotype:"irreversible aminoglycoside ototoxicity",
        note:"MT-RNR1 risk variants markedly increase aminoglycoside ototoxicity risk, including with paromomycin.",
        clinicalAction:"avoid aminoglycosides unless the severity of infection and lack of safe or effective alternatives outweigh permanent hearing-loss risk",
        evidenceRefs:["ev_aminoglycoside_mtrnr1_cpic2021"],
      },
      {
        parent:"Plazomicin",
        phenotype:"irreversible aminoglycoside ototoxicity",
        note:"MT-RNR1 risk variants markedly increase aminoglycoside ototoxicity risk, including with plazomicin.",
        clinicalAction:"avoid aminoglycosides unless the severity of infection and lack of safe or effective alternatives outweigh permanent hearing-loss risk",
        evidenceRefs:["ev_aminoglycoside_mtrnr1_cpic2021"],
      },
      {
        parent:"Ribostamycin",
        phenotype:"irreversible aminoglycoside ototoxicity",
        note:"MT-RNR1 risk variants markedly increase aminoglycoside ototoxicity risk, including with ribostamycin.",
        clinicalAction:"avoid aminoglycosides unless the severity of infection and lack of safe or effective alternatives outweigh permanent hearing-loss risk",
        evidenceRefs:["ev_aminoglycoside_mtrnr1_cpic2021"],
      },
    ],
  ...
  "RYR1/CACNA1S MH variant": {
    ...
    drugEffects:[
      ...
      },
      {
        parent:"Halothane",
        phenotype:"malignant hyperthermia trigger",
        note:"Halothane is a potent volatile anesthetic and malignant hyperthermia trigger in susceptible RYR1/CACNA1S variant carriers.",
        clinicalAction:"avoid; use non-triggering anesthesia",
        evidenceRefs:["ev_volatile_succinylcholine_ryr1_cacna1s_cpic2019"],
      },
    ],
  ...
  "GABRG2 variant": {
    ...
    drugEffects:[
      ...
      },
      {
        ...
        phenotype:"GABA-A receptor response context",
        note:"GABA-A receptor genetics may affect seizure biology and anti-seizure response context. Diognosis treats this as a review flag rather than a quantified PK effect.",
...
function normalizeGenePhenotypeInput(gene, value) {
  ...
  if (/^\s*(rm|rapid)\s*$/i.test(raw) || /rapid metabolizer/.test(normalized)) {
    return { ...base, phenotype:GENOTYPE_PHENOTYPE.UM, mechanism:"inherited_high_activity", note:"Diognosis currently maps rapid metabolizer reports into the high-activity bucket." };
  }
