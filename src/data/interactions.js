...
"Propafenone_PGx":{"primary":{"enzyme":"CYP2D6","metabolite":"5-Hydroxypropafenone","activity":"active_equipotent","pct":70},"diverted":[{"enzyme":"CYP3A4","metabolite":"N-depropylpropafenone","activity":"active","pct":15},{"enzyme":"CYP1A2","metabolite":"4-Hydroxypropafenone","activity":"weak","pct":10}],"clinicalImpact":"CYP2D6 PM: parent propafenone AUC ↑2.4×. Beta-blocking effect more pronounced. Propafenone itself inhibits CYP2D6 in EMs (phenoconversion) at higher doses.","severity":"high","pmEffect":"increased_exposure"}
};
  ...
  },
{
  ...
  {drug1:"Dronedarone",drug2:"Ciclosporin",severity:"severe",category:"metabolic",mechanism:"Both are CYP3A4 substrates; dronedarone increases ciclosporin exposure.",effect:"Nephrotoxicity risk ↑; avoid or monitor levels closely.",evidence:{confidence:"high",sources:["FDA label"]},evidenceRefs:["ev_dronedarone_cyp3a_pgp_label"]},
  ...
  {drug1:"Guanfacine",drug2:"Valproate",severity:"moderate",category:"metabolic",mechanism:"Valproate inhibits CYP3A4 (mild-moderate), raising guanfacine AUC ~2-fold.",effect:"Excessive sedation/bradycardia; reduce guanfacine dose by 50%.",evidence:{confidence:"high",sources:["FDA label"]},evidenceRefs:["ev_guanfacine_cyp3a_label"]},
