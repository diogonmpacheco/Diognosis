// Diognosis — Study database and evidence ingestion pipeline
// Phase A: modular source — concatenated by build.js

const STUDY_DB = {

  "ev_fda_pharmacogenetic_associations_2026": {
    id:"ev_fda_pharmacogenetic_associations_2026",
    public:true,
    type:EVIDENCE_TIER.GUIDELINE,
    sourceCategory:SOURCE_CATEGORY.AUTHORITY_SOURCE,
    authorityLevel:"regulatory_authority",
    claimSpecificity:"gene_drug_association",
    ...
    studyDesign:"regulatory_evidence_table",
    n:null,
    phenotypes:["CYP2D6","CYP2C19","CYP2C9","DPYD","TPMT","NUDT15","SLCO1B1"],
    quantifiedEffects:{note:"FDA regulatory evidence table describing gene-drug associations with therapeutic-management, safety/response, or pharmacokinetic relevance. Drug-specific labeling remains the source for exact prescribing instructions."},
    temporal:{},
    supports:[
      "clopidogrel_CYP2C19_prodrug","codeine_cyp2d6_dependence","tramadol_CYP2D6_activation",
      "fluoropyrimidine_DPYD_toxicity","thiopurine_TPMT_NUDT15_myelosuppression",
      "simvastatin_SUBSTRATE_OF_SLCO1B1","atorvastatin_SUBSTRATE_OF_SLCO1B1","rosuvastatin_SUBSTRATE_OF_SLCO1B1",
      "metoprolol_CYP2D6_exposure"
    ],
    contradicts:[],
    limitations:["Association-level authority source; exact phenotype wording, indication, dose, contraindications, and management must be checked in current drug labeling or a claim-specific guideline."],
    verified:false
  },
  ...
  "ev_fluoxetine_cyp2d6_fda": {
    ...
    sourceCategory:SOURCE_CATEGORY.AUTHORITY_SOURCE, authorityLevel:"regulatory_label", claimSpecificity:"drug_interaction_section",
    pmid:null, doi:null,
    url:"https://dailymed.nlm.nih.gov/dailymed/drugInfo.cfm?setid=d7a4db7f-cdac-2b36-e053-2995a90a8d64",
    studyDesign:"regulatory_label", n:null,
    phenotypes:["normal_metabolizer"],
    quantifiedEffects:{
  ...
  "ev_codeine_cyp2d6_cpic": {
    ...
    sourceCategory:SOURCE_CATEGORY.AUTHORITY_SOURCE, authorityLevel:"recognized_guideline", claimSpecificity:"gene_drug_recommendation",
    pmid:"24458010", doi:"10.1038/clpt.2013.254", url:"https://cpicpgx.org/guidelines/guideline-for-codeine-and-cyp2d6/",
  ...
  "ev_clopidogrel_cyp2c19_cpic": {
    ...
    sourceCategory:SOURCE_CATEGORY.AUTHORITY_SOURCE, authorityLevel:"recognized_guideline", claimSpecificity:"gene_drug_recommendation",
    pmid:"35034351", doi:"10.1002/cpt.2526", url:"https://files.cpicpgx.org/data/guideline/publication/clopidogrel/2022/35034351.pdf",
    studyDesign:"systematic_review_guideline", n:null,
  ...
  "ev_nebivolol_cyp2d6_label": {
    ...
    n:null,
    phenotypes:["poor_metabolizer","normal_metabolizer"],
    quantifiedEffects:{note:"Nebivolol is extensively metabolized by CYP2D6. FDA/DailyMed labeling reports higher d-nebivolol exposure in poor metabolizers and does not recommend routine dose adjustment by CYP2D6 status alone; published PK studies report substantially higher parent exposure, while the main hypertension study found similar blood-pressure response and tolerability."},
    ...
    contradicts:[],
    limitations:["Metabolite pool is simplified","Use as monitoring context only; this source does not establish an automatic genotype-only dose change for nebivolol"],
    verified:false
  },
  ...
  "ev_opioid_cyp2d6_cpic_2020": {
    ...
    sourceCategory:SOURCE_CATEGORY.AUTHORITY_SOURCE, authorityLevel:"recognized_guideline", claimSpecificity:"gene_drug_recommendation",
    pmid:"33387367", doi:null, url:"https://cpicpgx.org/content/guideline/publication/opioids/2020/CPIC_opioids_PREPRINT.pdf",
    studyDesign:"clinical pharmacogenetic guideline",
    n:null,
  ...
  // They are provenance-linked V1 evidence; independent validation is not implied.
  "draft_metformin_oct2_elsby2018_28971610": {
    ...
    limitations:[
      ...
      "Primary-literature context; provenance-linked and not standalone clinical guidance"
    ],
    confidence:"low",
    needsFullText:true,
  ...
  "ev_sulfonylurea_cyp2c9_label_context": {
    ...
    n:null,
    phenotypes:["poor_metabolizer","intermediate_metabolizer","normal_metabolizer"],
    quantifiedEffects:{note:"Glipizide and glyburide labeling describes hepatic metabolism and hypoglycemia risk; CYP2C9 contributes substantially to oxidative clearance in the Diognosis model, so reduced CYP2C9 function is represented as a hypoglycemia-risk context rather than a genotype-only dose rule."},
  ...
  // ── Curated Gemini salvage batch 2 evidence stubs: provenance-linked without clinical validation ──
...
"ev_dofetilide_renal_cation_label": {
  ...
  "ev_chlorpromazine_cyp2d6_label": {
    ...
    contradicts:[],
    limitations:["Metabolite fractions and activity vary across sources; this provenance-linked context supports review and is not standalone clinical guidance."],
    verified:false
  },
  ...
  "ev_tafenoquine_relapse_lacerda2019": {
    ...
    year:2019, source:"Lacerda et al.", journal:"New England Journal of Medicine",
    pmid:"30650322", doi:"10.1056/NEJMoa1710775", url:"https://pubmed.ncbi.nlm.nih.gov/30650322/",
    studyDesign:"randomized_trial", n:522,
    phenotypes:[GENOTYPE_RISK_STATUS.ABSENT],
    quantifiedEffects:{hazardRatio:0.30, note:"In G6PD-normal participants, tafenoquine reduced recurrence risk versus placebo (HR 0.30); primaquine showed a similar relapse-prevention signal (HR 0.26). This supports efficacy context while preserving the separate G6PD safety gate."},
    temporal:{mechanism:"8-aminoquinoline radical cure plus prolonged tafenoquine exposure"},
  ...
  "ev_primaquine_g6pd_safety_bastiaens2018": {
    ...
    year:2018, source:"Bastiaens et al.", journal:"PLoS ONE",
    pmid:"29324864", doi:"10.1371/journal.pone.0190272", url:"https://pubmed.ncbi.nlm.nih.gov/29324864/",
    studyDesign:"open_label_randomized_safety_trials", n:null,
    phenotypes:[GENOTYPE_RISK_STATUS.PRESENT],
    quantifiedEffects:{note:"Public abstract reports hemoglobin declines in G6PD-deficient males after single low-dose primaquine, including mean maximum changes around -2 g/dL in Burkina Faso and The Gambia cohorts."},
    temporal:{mechanism:"primaquine oxidative metabolite stress with reduced G6PD red-cell reserve", onset:"days"},
  ...
  "ev_tacrolimus_liver_multigene_ladd2025": {
    ...
    year:2025, source:"Ladd et al.", journal:"Scientific Reports",
    pmid:"40604035", doi:"10.1038/s41598-025-09296-1", url:"https://pubmed.ncbi.nlm.nih.gov/40604035/",
    studyDesign:"transplant_pharmacokinetic_association", n:null,
    phenotypes:[GENOTYPE_PHENOTYPE.PM, GENOTYPE_PHENOTYPE.IM, GENOTYPE_PHENOTYPE.NM],
    quantifiedEffects:{note:"Public abstract reports early post-liver-transplant tacrolimus concentration/dose variation associated with recipient CYP3A4/CYP3A5/ABCB1 and donor CYP3A4/UGT1A4 genotypes, including higher C0/D ratios in CYP3A5*3 GG recipients."},
    temporal:{mechanism:"donor_liver_and_recipient_enzyme_transporter_genetics_affect_tacrolimus_troughs", onset:"early_post_transplant"},
  ...
  "ev_tacrolimus_renal_dose_model_srinivas2023": {
    ...
    year:2023, source:"Srinivas et al.", journal:"Frontiers in Pharmacology",
    pmid:"34916931", doi:"10.3389/fphar.2021.726784", url:"https://pubmed.ncbi.nlm.nih.gov/34916931/",
    studyDesign:"renal_transplant_pharmacokinetic_model", n:null,
    phenotypes:[GENOTYPE_PHENOTYPE.PM, GENOTYPE_PHENOTYPE.IM, GENOTYPE_PHENOTYPE.NM],
    quantifiedEffects:{note:"Public abstract describes a genotype-based initial tacrolimus dose model using CYP3A5, CYP3A4, and ABCB1 variants with trough and dose-adjusted trough follow-up in renal transplant recipients."},
    temporal:{mechanism:"CYP3A_and_ABCB1_variants_modify_initial_tacrolimus_dose_trough_relationship"},
  ...
  "ev_mycophenolate_abcg2_boribilui2022": {
    ...
    year:2022, source:"Boribilui et al.", journal:"Research Square",
    pmid:null, doi:"10.21203/rs.3.rs-2247771/v1", url:"https://doi.org/10.21203/rs.3.rs-2247771/v1",
    studyDesign:"exploratory_matched_cohort_preprint", n:null,
    phenotypes:[GENOTYPE_PHENOTYPE.IM, GENOTYPE_PHENOTYPE.PM],
    quantifiedEffects:{aucFold:1.45, clearanceReductionPct:30, note:"Preprint abstract reports ABCG2 c.421C>A carriers had about 40% higher dose-adjusted MPA exposure and about 30% lower apparent clearance versus matched wild-type recipients."},
    temporal:{mechanism:"ABCG2_transport_affects_mycophenolic_acid_exposure"},
  ...
  "ev_mycophenolate_ugt2b7_ting2009": {
    ...
    year:2009, source:"Ting", journal:"University of British Columbia thesis",
    pmid:null, doi:"10.14288/1.0067071", url:"https://doi.org/10.14288/1.0067071",
    studyDesign:"thoracic_transplant_pharmacokinetic_thesis", n:64,
    phenotypes:[GENOTYPE_PHENOTYPE.IM, GENOTYPE_PHENOTYPE.PM],
    quantifiedEffects:{aucFold:3, note:"Public abstract reports UGT2B7 variants associated with about 3-fold higher AcMPAG AUC and about 10-fold higher AcMPAG/MPA metabolic ratio, with high AcMPAG exposure linked to poorer clinical outcomes."},
    temporal:{mechanism:"UGT2B7_variation_changes_reactive_acyl_MPAG_formation"},
  ...
  "ev_methotrexate_hdmtx_pgpk_taylor2021": {
    ...
    year:2021, source:"Taylor et al.", journal:"Cancers",
    pmid:"34200242", doi:"10.3390/cancers13112837", url:"https://pubmed.ncbi.nlm.nih.gov/34200242/",
    studyDesign:"systematic_review", n:null,
    phenotypes:[],
    quantifiedEffects:{note:"Systematic review context for high-dose methotrexate pharmacokinetic variability, delayed clearance, nephrotoxicity, mucositis, seizures, neutropenia, and transporter/folate-pathway gene candidates."},
    temporal:{mechanism:"high_dose_methotrexate_clearance_and_intracellular_polyglutamate_variability"},
  ...
  "ev_methotrexate_pgtox_meta_song2021": {
    ...
    year:2021, source:"Song et al.", journal:"Frontiers in Pharmacology",
    pmid:"34744734", doi:"10.3389/fphar.2021.757464", url:"https://pubmed.ncbi.nlm.nih.gov/34744734/",
    studyDesign:"systematic_review_meta_analysis", n:4102,
    phenotypes:[GENOTYPE_RISK_STATUS.PRESENT, GENOTYPE_RISK_STATUS.ABSENT],
    quantifiedEffects:{oddsRatio:1.52, note:"Meta-analysis abstract reports MTHFR 677C>T associated with high-dose methotrexate hepatotoxicity in a dominant model (OR 1.52, 95% CI 1.03-2.23)."},
    temporal:{mechanism:"folate_pathway_and_transporter_context_for_high_dose_methotrexate_toxicity"},
  ...
  "ev_ondansetron_cyp2d6_cpic2017": {
    ...
    year:2017, source:"Bell et al. / CPIC", journal:"Clinical Pharmacology & Therapeutics",
    pmid:"28002639", doi:"10.1002/cpt.598", url:"https://pubmed.ncbi.nlm.nih.gov/28002639/",
    studyDesign:"clinical_pharmacogenetics_guideline", n:null,
    phenotypes:[GENOTYPE_PHENOTYPE.PM, GENOTYPE_PHENOTYPE.NM, GENOTYPE_PHENOTYPE.UM],
    quantifiedEffects:{note:"CPIC guideline context: CYP2D6 ultrarapid metabolism can reduce ondansetron/tropisetron response; genotype is a response flag rather than a QT-only risk rule."},
    temporal:{mechanism:"CYP2D6_ultrarapid_clearance_reduces_5HT3_antagonist_exposure_response"},
  ...
  "ev_batch_kinase_cyp3a_qt_labels": {
    ...
    title:"Batch 01-03 kinase inhibitor labels — CYP3A exposure and QT/myelosuppression context",
    year:2026, source:"FDA/DailyMed labels",
    pmid:null, doi:null, url:"https://dailymed.nlm.nih.gov/dailymed/search.cfm?query=ribociclib%20adagrasib%20lapatinib%20CYP3A",
    studyDesign:"regulatory_label_group", n:null,
    phenotypes:[],
    quantifiedEffects:{note:"Grouped label anchor for batch kinase inhibitors where CYP3A inhibition/induction changes exposure and where QT, hepatic, or myelosuppression context can drive monitoring."},
    temporal:{mechanism:"CYP3A_inhibition_induction_and_exposure_toxicity_context", onset:"days", offset:"days-weeks"},
  ...
  "ev_batch_vmat2_cyp2d6_labels": {
    ...
    title:"VMAT2 inhibitor labels — CYP2D6 exposure and QT/parkinsonism context",
    year:2026, source:"FDA/DailyMed labels",
    pmid:null, doi:null, url:"https://dailymed.nlm.nih.gov/dailymed/search.cfm?query=valbenazine%20deutetrabenazine%20tetrabenazine%20CYP2D6",
    studyDesign:"regulatory_label_group", n:null,
    phenotypes:["CYP2D6"],
    quantifiedEffects:{note:"Valbenazine, deutetrabenazine, and tetrabenazine have active metabolite/exposure sensitivity to CYP2D6 phenotype or strong CYP2D6 inhibition, with QT, parkinsonism, depression, and sedation context."},
    temporal:{mechanism:"CYP2D6_active_metabolite_exposure_context", onset:"days", offset:"days"},
  ...
  "ev_batch_gi_cyp3a_labels": {
    ...
    title:"Batch GI drug labels — CYP3A absorption and exposure interaction context",
    year:2026, source:"FDA/DailyMed labels",
    pmid:null, doi:null, url:"https://dailymed.nlm.nih.gov/dailymed/search.cfm?query=naloxegol%20naldemedine%20eluxadoline%20CYP3A",
    studyDesign:"regulatory_label_group", n:null,
    phenotypes:[],
    quantifiedEffects:{note:"Grouped label anchor for GI agents such as naloxegol, naldemedine, and eluxadoline where CYP3A/OATP/P-gp exposure changes or biliary-pancreatic risk context is label-relevant."},
    temporal:{mechanism:"CYP3A_transporter_and_gi_safety_context", onset:"days", offset:"days"},
  ...
  "ev_batch_cns_anticholinergic_beers_labels": {
    ...
    title:"Batch CNS/anticholinergic older-adult safety context — Beers-style burden rows",
    year:2026, source:"AGS Beers-style criteria + FDA/DailyMed labels",
    pmid:null, doi:null, url:"https://dailymed.nlm.nih.gov/dailymed/search.cfm?query=promethazine%20meclizine%20scopolamine%20anticholinergic",
    studyDesign:"guideline_regulatory_context", n:null,
    phenotypes:[],
    quantifiedEffects:{note:"Grouped source anchor for anticholinergic, sedating, extrapyramidal, orthostasis, QT, and fall-risk rows added for batch CNS/antiemetic/bladder/antipsychotic drugs."},
    temporal:{mechanism:"older_adult_CNS_anticholinergic_fall_risk_context"},
  ...
  "ev_batch_s1p_ms_labels": {
    ...
    title:"S1P and MS therapy labels — long offset, infection, bradycardia, and immune-reconstitution context",
    year:2026, source:"FDA/DailyMed labels",
    pmid:null, doi:null, url:"https://dailymed.nlm.nih.gov/dailymed/search.cfm?query=fingolimod%20ozanimod%20ponesimod%20siponimod",
    studyDesign:"regulatory_label_group", n:null,
    phenotypes:[],
    quantifiedEffects:{note:"Grouped label anchor for S1P receptor modulators and selected MS therapies with bradycardia, infection/lymphopenia, CYP2C9/CYP2C8/CYP3A context, and prolonged immunologic offset."},
    temporal:{mechanism:"S1P_modulator_persistence_and_immune_reconstitution", onset:"days-weeks", offset:"weeks-months"},
  ...
  "ev_batch_adc_payload_labels": {
    ...
    title:"Antibody-drug conjugate labels — payload active-moiety and toxicity context",
    year:2026, source:"FDA/DailyMed labels",
    pmid:null, doi:null, url:"https://dailymed.nlm.nih.gov/dailymed/search.cfm?query=brentuximab%20enfortumab%20sacituzumab%20trastuzumab%20deruxtecan",
    studyDesign:"regulatory_label_group", n:null,
    phenotypes:[],
    quantifiedEffects:{note:"Grouped label anchor for ADC payload active forms such as MMAE, SN-38, DM1, calicheamicin, and deruxtecan, where marrow, neuropathy, hepatic, pulmonary, and UGT/CYP context may matter."},
    temporal:{mechanism:"ADC_payload_release_and_clearance_context", onset:"days", offset:"weeks"},
  ...
  "ev_batch_hemostasis_labels": {
    ...
    title:"Batch hemostasis labels — anticoagulant, antiplatelet, and thrombopoietin interaction context",
    year:2026, source:"FDA/DailyMed labels",
    pmid:null, doi:null, url:"https://dailymed.nlm.nih.gov/dailymed/search.cfm?query=betrixaban%20cangrelor%20avatrombopag%20fostamatinib",
    studyDesign:"regulatory_label_group", n:null,
    phenotypes:[],
    quantifiedEffects:{note:"Grouped label anchor for batch hemostasis drugs where bleeding, thrombosis, CYP2C8/CYP2C9/CYP3A, P-gp/BCRP, and renal/hepatic context influence risk."},
    temporal:{mechanism:"hemostasis_exposure_and_pharmacodynamic_stack_context", onset:"hours-days", offset:"days"},
  ...
  "ev_batch_prodrug_active_metabolite_labels": {
    id:"ev_batch_prodrug_active_metabolite_labels", public:false, type:EVIDENCE_TIER.MODELED_CONTEXT,
    sourceCategory:SOURCE_CATEGORY.MODELED_CONTEXT, importedContextOnly:true, notSeverityBearing:true, authorityLevel:"grouped_source_search", claimSpecificity:"context_only",
    title:"Batch 01-03 prodrug and active-metabolite labels — active moiety promotion context",
    year:2026, source:"FDA/DailyMed labels",
    pmid:null, doi:null, url:"https://dailymed.nlm.nih.gov/dailymed/search.cfm?query=fosaprepitant%20baloxavir%20molnupiravir%20remdesivir%20fingolimod%20fumarate%20fostamatinib",
    studyDesign:"regulatory_label_group", n:null,
    phenotypes:[],
    quantifiedEffects:{note:"Grouped label anchor for batch substances promoted into parent-to-active-metabolite rows, including prodrugs, active nucleotide forms, active corticosteroid metabolites, ophthalmic ester prodrugs, and shared active moieties."},
    temporal:{mechanism:"prodrug_activation_active_metabolite_persistence_context", onset:"minutes-days", offset:"hours-weeks"},
  ...
  "ev_phase1_high_priority_metabolite_labels": {
    id:"ev_phase1_high_priority_metabolite_labels", public:false, type:EVIDENCE_TIER.MODELED_CONTEXT,
    sourceCategory:SOURCE_CATEGORY.MODELED_CONTEXT, importedContextOnly:true, notSeverityBearing:true, authorityLevel:"grouped_source_search", claimSpecificity:"context_only",
  ...
  "ev_phase2_label_interaction_expansion": {
    id:"ev_phase2_label_interaction_expansion", public:false, type:EVIDENCE_TIER.MODELED_CONTEXT,
    sourceCategory:SOURCE_CATEGORY.MODELED_CONTEXT, importedContextOnly:true, notSeverityBearing:true, authorityLevel:"grouped_source_search", claimSpecificity:"context_only",
  ...
  "ev_phase3_pk_washout_labels": {
    id:"ev_phase3_pk_washout_labels", public:false, type:EVIDENCE_TIER.MODELED_CONTEXT,
    sourceCategory:SOURCE_CATEGORY.MODELED_CONTEXT, importedContextOnly:true, notSeverityBearing:true, authorityLevel:"grouped_source_search", claimSpecificity:"context_only",
  ...
  "ev_phase4_genotype_metabolite_expansion": {
    id:"ev_phase4_genotype_metabolite_expansion", public:false, type:EVIDENCE_TIER.MODELED_CONTEXT,
    sourceCategory:SOURCE_CATEGORY.MODELED_CONTEXT, importedContextOnly:true, notSeverityBearing:true, authorityLevel:"grouped_source_search", claimSpecificity:"context_only",
  ...
  "ev_phase5_receptor_burden_profiles": {
    id:"ev_phase5_receptor_burden_profiles", public:false, type:EVIDENCE_TIER.MODELED_CONTEXT,
    sourceCategory:SOURCE_CATEGORY.MODELED_CONTEXT, importedContextOnly:true, notSeverityBearing:true, authorityLevel:"grouped_source_search", claimSpecificity:"context_only",
  ...
  "ev_phase6_clinical_context_enrichment": {
    id:"ev_phase6_clinical_context_enrichment", public:false, type:EVIDENCE_TIER.MODELED_CONTEXT,
    sourceCategory:SOURCE_CATEGORY.MODELED_CONTEXT, importedContextOnly:true, notSeverityBearing:true, authorityLevel:"grouped_source_search", claimSpecificity:"context_only",
  ...
  "ev_top100_live_coverage_adapter": {
    id:"ev_top100_live_coverage_adapter", public:false, type:EVIDENCE_TIER.MODELED_CONTEXT,
    sourceCategory:SOURCE_CATEGORY.MODELED_CONTEXT, importedContextOnly:true, notSeverityBearing:true, authorityLevel:"internal_model", claimSpecificity:"context_only",
    ...
    quantifiedEffects:{note:"Shared evidence anchor for live top-100 promotion adapters. Rows expose existing route, transporter, timing, genotype, and burden knowledge in calculation pathways while source-specific support remains incomplete."},
  ...
  "ev_top250_live_coverage_adapter": {
    id:"ev_top250_live_coverage_adapter", public:false, type:EVIDENCE_TIER.MODELED_CONTEXT,
    sourceCategory:SOURCE_CATEGORY.MODELED_CONTEXT, importedContextOnly:true, notSeverityBearing:true, authorityLevel:"internal_model", claimSpecificity:"context_only",
  ...
  "ev_top100_gold_enrichment_adapter": {
    id:"ev_top100_gold_enrichment_adapter", public:false, type:EVIDENCE_TIER.MODELED_CONTEXT,
    sourceCategory:SOURCE_CATEGORY.MODELED_CONTEXT, importedContextOnly:true, notSeverityBearing:true, authorityLevel:"internal_model", claimSpecificity:"context_only",
  ...
  "ev_ninety_percent_live_coverage_adapter": {
    id:"ev_ninety_percent_live_coverage_adapter", public:false, type:EVIDENCE_TIER.MODELED_CONTEXT,
    sourceCategory:SOURCE_CATEGORY.MODELED_CONTEXT, importedContextOnly:true, notSeverityBearing:true, authorityLevel:"internal_model", claimSpecificity:"context_only",
  ...
  "ev_fluorouracil_warfarin_label": {
    ...
    title:"Fluorouracil prescribing information - vitamin K antagonist interaction",
    year:2026, source:"FDA / DailyMed", journal:null, pmid:null, doi:null,
    url:"https://dailymed.nlm.nih.gov/dailymed/lookup.cfm?setid=1daf714b-704c-4bcc-b6e0-6f0eb2bfe66b",
    studyDesign:"regulatory_label", n:null, phenotypes:[],
    quantifiedEffects:{note:"Fluorouracil labeling reports elevated INR and prothrombin time with concomitant warfarin/vitamin K antagonists and recommends more frequent INR/PT monitoring."},
    temporal:{mechanism:"fluoropyrimidine_vitamin_k_antagonist_anticoagulation_response"},
  ...
  "ev_capecitabine_warfarin_label": {
    ...
    title:"Capecitabine prescribing information - warfarin/vitamin K antagonist interaction",
    year:2026, source:"FDA / DailyMed", journal:null, pmid:null, doi:null,
    url:"https://dailymed.nlm.nih.gov/dailymed/drugInfo.cfm?setid=01bf8c52-7f60-4fa5-8257-847bc0d910a4",
    studyDesign:"regulatory_label", n:null, phenotypes:[],
    quantifiedEffects:{note:"Capecitabine labeling describes clinically important INR/PT increases with warfarin or other coumarin anticoagulants, including events during treatment and within about one month after stopping."},
    temporal:{onset:"days-months", offset:"up_to_1_month_after_stop", mechanism:"fluoropyrimidine_vka_anticoagulation_response"},
  ...
  "ev_caspofungin_rifampin_label": {
    ...
    title:"Caspofungin prescribing information - rifampin and hepatic enzyme inducer interaction",
    year:2026, source:"FDA / DailyMed", journal:null, pmid:null, doi:null,
    url:"https://dailymed.nlm.nih.gov/dailymed/drugInfo.cfm?setid=e76d8d83-3691-451c-a32c-d91448c54d16",
    studyDesign:"regulatory_label", n:null, phenotypes:[],
    quantifiedEffects:{troughReductionPct:30, note:"Caspofungin labeling reports a 30% decrease in trough concentrations with rifampin and recommends 70 mg daily in adults receiving rifampin; other hepatic enzyme inducers may also require dose consideration."},
    temporal:{mechanism:"inducer_reduces_caspofungin_exposure"},
  ...
  "ev_micafungin_sirolimus_itraconazole_nifedipine_label": {
    ...
    title:"Micafungin prescribing information - sirolimus, nifedipine, and itraconazole exposure increases",
    year:2026, source:"FDA / DailyMed", journal:null, pmid:null, doi:null,
    url:"https://dailymed.nlm.nih.gov/dailymed/lookup.cfm?setid=70b3f044-95ca-4503-b669-ed39972592b6",
    studyDesign:"regulatory_label", n:null, phenotypes:[],
    quantifiedEffects:{sirolimusAucIncreasePct:21, nifedipineAucIncreasePct:18, nifedipineCmaxIncreasePct:42, itraconazoleAucIncreasePct:22, itraconazoleCmaxIncreasePct:11, note:"Micafungin labeling recommends monitoring sirolimus, nifedipine, or itraconazole toxicity and reducing dose if necessary."},
    temporal:{mechanism:"micafungin_increases_selected_cyp3a_substrate_exposure"},
  ...
  "ev_anidulafungin_pk_label": {
    ...
    title:"Anidulafungin prescribing information - slow chemical degradation, PK, and low CYP interaction potential",
    year:2026, source:"FDA / DailyMed", journal:null, pmid:null, doi:null,
    url:"https://dailymed.nlm.nih.gov/dailymed/lookup.cfm?setid=a88d9010-55fb-4a02-baff-042cd27688ea",
    studyDesign:"regulatory_label", n:null, phenotypes:[],
    quantifiedEffects:{terminalHalfLifeHours:"40-50", degradationHalfLifeHours:24, note:"Anidulafungin labeling describes IV dose-proportional PK, terminal half-life about 40-50 hours, slow chemical degradation to inactive ring-opened peptide, and no clinically relevant CYP450 substrate/inducer/inhibitor behavior."},
    temporal:{mechanism:"chemical_degradation_and_biliary_fecal_elimination"},
  ...
  "ev_acetaminophen_metabolism_label": {
    ...
    title:"Acetaminophen injection prescribing information - glucuronide, sulfate, CYP2E1/NAPQI, and glutathione detoxification pathways",
    year:2026, source:"FDA / DailyMed", journal:null, pmid:null, doi:null,
    url:"https://dailymed.nlm.nih.gov/dailymed/lookup.cfm?setid=dc42ab17-cd30-4d1a-e053-2995a90a86ea",
    studyDesign:"regulatory_label", n:null, phenotypes:[],
    quantifiedEffects:{note:"Acetaminophen labeling describes three principal hepatic pathways: glucuronidation, sulfation, and CYP2E1 oxidation to NAPQI; at therapeutic doses NAPQI is conjugated by glutathione to cysteine and mercapturic acid conjugates."},
    temporal:{mechanism:"phase_ii_conjugation_and_cyp2e1_napqi_detoxification"},
  ...
  "ev_acarbose_digoxin_label": {
    ...
    title:"Acarbose prescribing information - digoxin bioavailability interaction and minimal systemic exposure",
    year:2026, source:"FDA / DailyMed", journal:null, pmid:null, doi:null,
    url:"https://dailymed.nlm.nih.gov/dailymed/drugInfo.cfm?setid=d1b627e1-d78d-47dd-93f5-2bf4998466ba",
    studyDesign:"regulatory_label", n:null, phenotypes:[],
    quantifiedEffects:{note:"Acarbose labeling states that acarbose can change digoxin bioavailability and may require digoxin dose adjustment. Acarbose is minimally absorbed and acts primarily in the gut lumen."},
    temporal:{mechanism:"gut_lumen_absorption_or_bioavailability_shift"},
  ...
  "ev_amikacin_toxicity_label": {
    ...
    title:"Amikacin prescribing information - potent diuretics, nephrotoxicity, ototoxicity, and neuromuscular blockade",
    year:2026, source:"FDA / DailyMed", journal:null, pmid:null, doi:null,
    url:"https://dailymed.nlm.nih.gov/dailymed/drugInfo.cfm?audience=consumer&setid=a43188fa-f228-4acd-8a5d-9a3462034f4b",
    studyDesign:"regulatory_label", n:null, phenotypes:[],
    quantifiedEffects:{note:"Amikacin labeling warns to avoid concurrent potent diuretics such as furosemide or ethacrynic acid due to ototoxicity concerns and describes aminoglycoside nephrotoxicity, ototoxicity, and neuromuscular blockade/respiratory paralysis risks."},
    temporal:{mechanism:"renal_aminoglycoside_exposure_plus_ototoxic_or_neuromuscular_toxicity_stack"},
  ...
  "ev_anagrelide_cyp1a2_aspirin_label": {
    ...
    title:"Anagrelide prescribing information - CYP1A2 inhibitors, cardiovascular monitoring, and aspirin bleeding context",
    year:2026, source:"FDA / DailyMed", journal:null, pmid:null, doi:null,
    url:"https://dailymed.nlm.nih.gov/dailymed/drugInfo.cfm?setid=875cc32a-219c-4b6b-802a-98a47cbc9a78",
    studyDesign:"regulatory_label", n:null, phenotypes:[],
    quantifiedEffects:{note:"Anagrelide and its active metabolite are primarily metabolized by CYP1A2; labeling states CYP1A2 inhibitors such as fluvoxamine or ciprofloxacin can increase exposure and require cardiovascular monitoring. Aspirin-containing labels also warn increased bleeding risk with anagrelide."},
    temporal:{mechanism:"CYP1A2_exposure_increase_plus_platelet_function_bleeding_stack"},
  ...
  "ev_apomorphine_5ht3_label": {
    ...
    title:"Apomorphine prescribing information - contraindicated 5-HT3 antagonist interaction",
    year:2026, source:"FDA / DailyMed", journal:null, pmid:null, doi:null,
    url:"https://dailymed.nlm.nih.gov/dailymed/lookup.cfm?setid=aedf70e4-1949-44bc-bf1b-0f282c4f0705",
    studyDesign:"regulatory_label", n:null, phenotypes:[],
    quantifiedEffects:{note:"Apomorphine labeling contraindicates concomitant 5-HT3 antagonists including ondansetron, granisetron, dolasetron, palonosetron, and alosetron because profound hypotension and loss of consciousness have been reported."},
    temporal:{mechanism:"apomorphine_5ht3_antagonist_hypotension_syncope"},
  ...
  "ev_atenolol_ccb_label": {
    ...
    title:"Atenolol prescribing information - verapamil/diltiazem bradycardia and heart-block context",
    year:2026, source:"FDA / DailyMed", journal:null, pmid:null, doi:null,
    url:"https://dailymed.nlm.nih.gov/dailymed/lookup.cfm?setid=a2d29601-21aa-4e78-a725-6c1ea982e3ac",
    studyDesign:"regulatory_label", n:null, phenotypes:[],
    quantifiedEffects:{note:"Atenolol labeling warns that bradycardia and heart block can occur when beta-blockers are administered with verapamil or diltiazem, especially in patients with conduction abnormalities or left ventricular dysfunction."},
    temporal:{mechanism:"additive_AV_node_and_sinus_node_slowing"},
  ...
  "ev_enoxaparin_hemostasis_label": {
    ...
    title:"Enoxaparin prescribing information - hemostasis-affecting drugs and bleeding/spinal hematoma risk",
    year:2026, source:"FDA / DailyMed", journal:null, pmid:null, doi:null,
    url:"https://dailymed.nlm.nih.gov/dailymed/drugInfo.cfm?setid=afec67a9-ae16-4f48-bc0b-5331835e8aa2",
    studyDesign:"regulatory_label", n:null, phenotypes:[],
    quantifiedEffects:{note:"Enoxaparin labeling warns that concomitant NSAIDs, platelet inhibitors, and other anticoagulants increase bleeding and neuraxial hematoma risk; monitoring is required when overlap cannot be avoided."},
    temporal:{mechanism:"additive_anticoagulant_antiplatelet_hemostasis_impairment"},
  ...
  "ev_dalteparin_hemostasis_label": {
    ...
    title:"Dalteparin prescribing information - hemostasis-affecting drugs and spinal/epidural hematoma risk",
    year:2026, source:"FDA / DailyMed", journal:null, pmid:null, doi:null,
    url:"https://dailymed.nlm.nih.gov/dailymed/drugInfo.cfm?setid=23527b8b-9b28-4e6d-9751-33b143975ac7",
    studyDesign:"regulatory_label", n:null, phenotypes:[],
    quantifiedEffects:{note:"Dalteparin labeling warns that NSAIDs, platelet inhibitors, and other anticoagulants can increase spinal/epidural hematoma and bleeding risk, especially around neuraxial procedures."},
    temporal:{mechanism:"additive_hemostasis_impairment_and_neuraxial_bleeding_context"},
  ...
  "ev_formoterol_label": {
    ...
    title:"Formoterol prescribing information - beta-blockers, MAO inhibitors, TCAs, and QT-prolonging drugs",
    year:2026, source:"FDA / DailyMed", journal:null, pmid:null, doi:null,
    url:"https://dailymed.nlm.nih.gov/dailymed/lookup.cfm?setid=d8f7c5ff-bd3c-4eab-b58a-1e3a478e5879",
    studyDesign:"regulatory_label", n:null, phenotypes:[],
    quantifiedEffects:{note:"Formoterol labeling includes interaction warnings for beta-blockers, MAO inhibitors, tricyclic antidepressants, and QTc-prolonging drugs because beta-agonist cardiovascular effects can be antagonized or potentiated."},
    temporal:{mechanism:"beta2_agonism_antagonism_or_cardiovascular_potentiation"},
  ...
  "ev_carbidopa_levodopa_label": {
    ...
    title:"Carbidopa/levodopa prescribing information - nonselective MAOI contraindication, iron chelation, and dopamine antagonist loss of effect",
    year:2026, source:"FDA / DailyMed", journal:null, pmid:null, doi:null,
    url:"https://dailymed.nlm.nih.gov/dailymed/lookup.cfm?setid=2cdca970-f077-3a80-e063-6294a90ab335",
    studyDesign:"regulatory_label", n:null, phenotypes:[],
    quantifiedEffects:{note:"Carbidopa/levodopa labeling contraindicates nonselective MAO inhibitors unless stopped at least two weeks before initiation; iron salts can chelate and reduce bioavailability, and dopamine D2 antagonists can reduce therapeutic effect."},
    temporal:{mechanism:"dopaminergic_effect_stack_absorption_chelation_and_monoamine_hypertension_context"},
  ...
  "ev_denosumab_label": {
    ...
    title:"Denosumab prescribing information - RANKL binding, hypocalcemia risk, and long half-life",
    year:2026, source:"FDA / DailyMed", journal:null, pmid:null, doi:null,
    url:"https://dailymed.nlm.nih.gov/dailymed/drugInfo.cfm?setid=49e5afe9-a0c7-40c4-af9f-f287a80c5c88",
    studyDesign:"regulatory_label", n:null, phenotypes:[],
    quantifiedEffects:{halfLifeDays:25.4, note:"Denosumab binds RANKL, prevents RANK activation on osteoclast lineage cells, can cause severe hypocalcemia, and has a mean half-life around 25 days in label pharmacokinetic data."},
    temporal:{mechanism:"RANKL_inhibition_and_long_antibody_persistence"},
  ...
  "ev_dupilumab_label": {
    ...
    title:"Dupilumab prescribing information - IL-4 receptor alpha antagonism and cytokine/CYP context",
    year:2026, source:"FDA / DailyMed", journal:null, pmid:null, doi:null,
    url:"https://dailymed.nlm.nih.gov/dailymed/search.cfm?labeltype=human&query=Dupilumab",
    studyDesign:"regulatory_label", n:null, phenotypes:[],
    quantifiedEffects:{note:"Dupilumab is an IL-4 receptor alpha antagonist that inhibits IL-4 and IL-13 signaling. Labeling describes cytokine pathway modulation and cautions that CYP450 formation may normalize after inflammatory blockade."},
    temporal:{mechanism:"IL4R_alpha_blockade_type2_inflammation_and_cytokine_CYP_context"},
  ...
  "ev_eculizumab_label": {
    ...
    title:"Eculizumab prescribing information - complement C5 inhibition, meningococcal infection risk, and plasma exchange clearance",
    year:2026, source:"FDA / DailyMed", journal:null, pmid:null, doi:null,
    url:"https://dailymed.nlm.nih.gov/dailymed/lookup.cfm?setid=ebcd67fa-b4d1-4a22-b33d-ee8bf6b9c722",
    studyDesign:"regulatory_label", n:null, phenotypes:[],
    quantifiedEffects:{halfLifeHours:"141-882", note:"Eculizumab is a complement inhibitor that increases susceptibility to serious meningococcal infections. Label PK notes a long half-life range and increased clearance with plasma exchange or infusion, requiring supplemental dosing."},
    temporal:{mechanism:"terminal_complement_C5_inhibition_and_plasma_exchange_clearance"},
  ...
  "ev_canakinumab_label": {
    ...
    title:"Canakinumab prescribing information - IL-1 beta blockade and infection/CYP context",
    year:2026, source:"FDA / DailyMed", journal:null, pmid:null, doi:null,
    url:"https://dailymed.nlm.nih.gov/dailymed/drugInfo.cfm?setid=7d271f3b-e4f9-4d80-8dcf-28d49123f80e",
    studyDesign:"regulatory_label", n:null, phenotypes:[],
    quantifiedEffects:{note:"Canakinumab is an interleukin-1 beta blocker. Labeling warns about serious infection risk and notes cytokine modulation can normalize CYP450 enzyme formation, creating context for narrow therapeutic index CYP substrates."},
    temporal:{mechanism:"IL1B_blockade_infection_risk_and_cytokine_CYP_normalization_context"},
  ...
  "ev_desmopressin_hyponatremia_label": {
    ...
    title:"Desmopressin prescribing information - loop diuretic/glucocorticoid contraindication and hyponatremia risk",
    year:2026, source:"FDA / DailyMed", journal:null, pmid:null, doi:null,
    url:"https://dailymed.nlm.nih.gov/dailymed/drugInfo.cfm?setid=b01c22dc-eecd-11b2-e053-2a95a90a529a",
    studyDesign:"regulatory_label", n:null, phenotypes:[],
    quantifiedEffects:{note:"Desmopressin labeling contraindicates use in patients at increased risk of severe hyponatremia, including those using loop diuretics or systemic/inhaled glucocorticoids, and warns severe hyponatremia can be life-threatening."},
    temporal:{mechanism:"V2_antidiuresis_water_retention_plus_hyponatremia_risk_drugs"},
  ...
  "ev_fexofenadine_transporter_label": {
    ...
    title:"Fexofenadine prescribing information - ketoconazole/erythromycin exposure increase and fruit juice absorption reduction",
    year:2026, source:"FDA / DailyMed", journal:null, pmid:null, doi:null,
    url:"https://dailymed.nlm.nih.gov/dailymed/drugInfo.cfm?setid=9738127d-7308-454c-94c8-3229d507370f",
    studyDesign:"regulatory_label", n:null, phenotypes:[],
    quantifiedEffects:{antacidAucReductionPct:41, antacidCmaxReductionPct:43, note:"Fexofenadine labeling states ketoconazole or erythromycin increase fexofenadine plasma concentrations, fruit juices reduce bioavailability/exposure, and aluminum/magnesium antacids reduce AUC/Cmax."},
    temporal:{mechanism:"intestinal_transporter_and_binding_absorption_context"},
  ...
  "ev_abatacept_tnf_label": {
    ...
    title:"Abatacept prescribing information - TNF antagonist infection-risk interaction",
    year:2026, source:"FDA / DailyMed", journal:null, pmid:null, doi:null,
    url:"https://dailymed.nlm.nih.gov/dailymed/search.cfm?labeltype=human&query=Abatacept",
    studyDesign:"regulatory_label", n:null, phenotypes:[],
    quantifiedEffects:{note:"Abatacept labeling states concomitant TNF antagonist administration has been associated with increased serious infection risk and no significant additional efficacy; concurrent therapy is not recommended."},
    temporal:{mechanism:"additive_biologic_immunosuppression_infection_risk"},
  ...
  "ev_canagliflozin_diuretic_label": {
    ...
    title:"Canagliflozin prescribing information - volume depletion with loop diuretics",
    year:2026, source:"FDA / DailyMed", journal:null, pmid:null, doi:null,
    url:"https://dailymed.nlm.nih.gov/dailymed/drugInfo.cfm?setid=5f76e16f-0c24-454a-81af-4080b312c940",
    studyDesign:"regulatory_label", n:null, phenotypes:[],
    quantifiedEffects:{note:"Canagliflozin labeling warns volume depletion can lead to symptomatic hypotension or acute kidney injury, especially in patients with renal impairment, older adults, and patients on loop diuretics."},
    temporal:{mechanism:"osmotic_diuresis_plus_diuretic_volume_depletion"},
  ...
  "ev_benztropine_anticholinergic_label": {
    ...
    title:"Benztropine prescribing information - anticholinergic and antihistaminic activity",
    year:2026, source:"FDA / DailyMed", journal:null, pmid:null, doi:null,
    url:"https://dailymed.nlm.nih.gov/dailymed/drugInfo.cfm?setid=b7f915a9-cd53-4a74-8ee5-35ee5c5c991e",
    studyDesign:"regulatory_label", n:null, phenotypes:[],
    quantifiedEffects:{note:"Benztropine labeling describes anticholinergic and antihistaminic activity, with anticholinergic activity therapeutically significant in parkinsonism."},
    temporal:{mechanism:"central_and_peripheral_antimuscarinic_burden"},
...
"ev_cetirizine_pk_cns_label": {
    ...
    year:2026, source:"FDA / DailyMed", journal:null, pmid:null, doi:null,
    url:"https://dailymed.nlm.nih.gov/dailymed/lookup.cfm?setid=a9b21d71-106e-4bd5-aaab-9254c8a44e0d",
    studyDesign:"regulatory_label", n:null, phenotypes:[],
    quantifiedEffects:{note:"Cetirizine labeling reports somnolence in some patients, cautions against alcohol or other CNS depressants, and uses lower starting doses in renal or hepatic impairment."},
    temporal:{mechanism:"second_generation_antihistamine_sedation_and_renal_clearance_context"},
...
"ev_exenatide_gastric_emptying_label": {
    ...
    year:2026, source:"FDA / DailyMed", journal:null, pmid:null, doi:null,
    url:"https://dailymed.nlm.nih.gov/dailymed/drugInfo.cfm?setid=53d03c03-ebf7-418d-88a8-533eabd2ee4f",
    studyDesign:"regulatory_label", n:null, phenotypes:[],
    quantifiedEffects:{note:"Exenatide labeling states it slows gastric emptying and can reduce the rate of absorption of oral medicines; hypoglycemia risk increases with insulin or insulin secretagogues."},
    temporal:{mechanism:"delayed_gastric_emptying_and_glucose_lowering_additivity"},
  ...
  "ev_rasagiline_cyp1a2_serotonin_label": {
    ...
    title:"Rasagiline prescribing information - CYP1A2 inhibition and serotonergic/opioid interaction restrictions",
    year:2026, source:"FDA / DailyMed", journal:null, pmid:null, doi:null,
    url:"https://dailymed.nlm.nih.gov/dailymed/drugInfo.cfm?setid=a62a9946-755f-47d0-afe6-edc8f7d641fe",
    studyDesign:"regulatory_label", n:null, phenotypes:["CYP1A2","MAO-B"],
    quantifiedEffects:{aucFold:2, note:"Rasagiline labeling says ciprofloxacin and other CYP1A2 inhibitors can raise rasagiline concentrations up to about 2-fold; labeling also restricts use with selected serotonergic opioids and MAO inhibitors."},
    temporal:{mechanism:"CYP1A2_inhibition_plus_MAO_B_serotonergic_context"},
  ...
  "ev_ropinirole_cyp1a2_label": {
    ...
    title:"Ropinirole prescribing information - CYP1A2 inhibitor/inducer exposure changes",
    year:2026, source:"FDA / DailyMed", journal:null, pmid:null, doi:null,
    url:"https://dailymed.nlm.nih.gov/dailymed/lookup.cfm?setid=7bf874a3-4d45-41ab-9796-6729f409031c",
    studyDesign:"regulatory_label", n:null, phenotypes:["CYP1A2"],
    quantifiedEffects:{note:"Ropinirole labeling states CYP1A2 is the major metabolic enzyme; ciprofloxacin increases ropinirole AUC/Cmax and smoking may increase clearance through CYP1A2 induction."},
    temporal:{mechanism:"CYP1A2_inhibition_or_induction_changes_dopamine_agonist_exposure"},
  ...
  "ev_pramipexole_renal_cation_label": {
    ...
    title:"Pramipexole prescribing information - unchanged renal excretion and organic cation tubular secretion",
    year:2026, source:"FDA / DailyMed", journal:null, pmid:null, doi:null,
    url:"https://dailymed.nlm.nih.gov/dailymed/lookup.cfm?setid=f4d97c2e-f447-4cfe-b9d4-852323f0cfb5",
    studyDesign:"regulatory_label", n:null, phenotypes:["renal_cation_transport"],
    quantifiedEffects:{renalRecoveryPct:90, note:"Pramipexole labeling states urinary excretion is the major route, about 90% of dose is recovered in urine mostly unchanged, and renal clearance exceeds GFR, consistent with organic cation tubular secretion."},
    temporal:{mechanism:"renal_organic_cation_tubular_secretion"},
  ...
  "ev_botulinum_toxin_neuromuscular_label": {
    ...
    title:"Botulinum toxin type A prescribing information - aminoglycoside and neuromuscular transmission caution",
    year:2026, source:"FDA / DailyMed", journal:null, pmid:null, doi:null,
    url:"https://dailymed.nlm.nih.gov/dailymed/drugInfo.cfm?setid=97513722-8426-4ce3-b85d-0e08e436a140",
    studyDesign:"regulatory_label", n:null, phenotypes:["neuromuscular_transmission"],
    quantifiedEffects:{note:"Botulinum toxin type A labeling cautions that aminoglycosides or other agents interfering with neuromuscular transmission may potentiate botulinum toxin effects."},
    temporal:{mechanism:"additive_neuromuscular_transmission_blockade"},
...
"ev_ddi_expansion_pack_adapter": {
    id:"ev_ddi_expansion_pack_adapter", public:false, type:EVIDENCE_TIER.MODELED_CONTEXT,
    sourceCategory:SOURCE_CATEGORY.MODELED_CONTEXT, importedContextOnly:true, notSeverityBearing:true, authorityLevel:"internal_model", claimSpecificity:"context_only",
  ...
  "ev_metabolite_expansion_pack_adapter": {
    id:"ev_metabolite_expansion_pack_adapter", public:false, type:EVIDENCE_TIER.MODELED_CONTEXT,
    sourceCategory:SOURCE_CATEGORY.MODELED_CONTEXT, importedContextOnly:true, notSeverityBearing:true, authorityLevel:"internal_model", claimSpecificity:"context_only",
    ...
    quantifiedEffects:{note:"Shared evidence anchor for adding source-priority METAB rows and first-class metabolite actors where route and active-moiety context should be visible in the live graph before named-metabolite curation is complete."},
  ...
  "ev_pgx_transporter_expansion_adapter": {
    id:"ev_pgx_transporter_expansion_adapter", public:false, type:EVIDENCE_TIER.MODELED_CONTEXT,
    sourceCategory:SOURCE_CATEGORY.MODELED_CONTEXT, importedContextOnly:true, notSeverityBearing:true, authorityLevel:"internal_model", claimSpecificity:"context_only",
    ...
    quantifiedEffects:{note:"Shared evidence anchor for expanding source-priority genotype-metabolite rules and transporter interaction rows from already modeled route/transporter context."},
  ...
  "ev_phase15_source_backed_pgx_pairs": {
    id:"ev_phase15_source_backed_pgx_pairs", public:false, type:EVIDENCE_TIER.MODELED_CONTEXT,
    sourceCategory:SOURCE_CATEGORY.MODELED_CONTEXT, importedContextOnly:true, notSeverityBearing:true, authorityLevel:"grouped_source_search", claimSpecificity:"context_only",
  ...
  "ev_drug_count_expansion_batch": {
    id:"ev_drug_count_expansion_batch", public:false, type:EVIDENCE_TIER.MODELED_CONTEXT,
    sourceCategory:SOURCE_CATEGORY.MODELED_CONTEXT, importedContextOnly:true, notSeverityBearing:true, authorityLevel:"internal_model", claimSpecificity:"context_only",
...
// DO NOT auto-publish extracted evidence without professional judgment.
//
// Pipeline flow:
...
function reviewStudyDraft(draftId, reviewerNotes, approve) {
  ...
  const published = { ...draft, _status:'approved', verified:false,
    verifyNote: reviewerNotes || 'Merged draft with linked provenance; no clinical validation', _approvedAt: new Date().toISOString() };
