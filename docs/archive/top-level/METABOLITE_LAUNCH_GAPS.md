...
- high-risk active/toxic metabolites that should remain visible in the Mechanisms or Genes + Metabolites tabs
...
| P0 | Busulfan | glutathione conjugates / TDM exposure context | GSTA1/GSTM1/GSTT1 | Narrow-index conditioning chemotherapy; GST variation is a clearance/toxicity signal but not a metabolite network row. | `METAB` row for GST conjugation context; possible Mechanisms actor for busulfan GST clearance. | Meta-analysis plus transplant PK/TDM guidance. |
...
| P1 | Vincristine | parent exposure / inactive metabolites | CYP3A5/ABCB1 | CYP3A5 fold exists, but Mechanisms needs a metabolite or explicit parent-exposure context for neurotoxicity. | CYP3A5 genotype-effect context, preferably not overstated as active metabolite biology. | Oncology label plus CYP3A5 PK/toxicity PMID. |
...
| P1 | Diazepam | nordiazepam / oxazepam | CYP2C19 | Active long-lived benzodiazepine metabolites affect sedation/falls; rows lack evidence refs. | `evidenceRefs`; possible first-class nordiazepam actor if Mechanisms visibility is desired. | FDA label plus benzodiazepine PK review. |
...
| P1 | Morphine | M3G/M6G | UGT2B7 | Active/toxic glucuronide balance matters in renal impairment and opioid toxicity. | `evidenceRefs`; possible Mechanisms actor for M6G if high-risk opioid metabolite view expands. | Opioid glucuronidation review and renal PK sources. |
...
| P2 | Cannabis (THC) | 11-OH-THC / THC-COOH | CYP2C9 | Active oral THC metabolite and inactive marker rows lack refs. | `evidenceRefs` and potential Mechanisms actor for 11-OH-THC. | Human cannabinoid PK review. |
