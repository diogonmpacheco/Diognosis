...
Generated: 2026-06-15T10:12:56.251Z
...
|---|---:|---:|---|---|
| Tacrolimus + fluconazole | 10 | 2 | exposure_increase_toxicity, washout_or_persistence | pass |
| Simvastatin + clarithromycin | 7 | 2 | exposure_increase_toxicity, washout_or_persistence | pass |
| Rifampin + simvastatin | 10 | 3 | model_only_mechanistic_context, active_metabolite_accumulation, washout_or_persistence | pass |
| Codeine + fluoxetine + CYP2D6 PM | 11 | 2 | activation_failure, washout_or_persistence | pass |
| Clopidogrel + omeprazole + CYP2C19 PM | 8 | 1 | activation_failure | pass |
| Irinotecan + UGT1A1 PM | 2 | 1 | toxic_metabolite_accumulation | pass |
| Capecitabine + DPYD PM | 2 | 1 | toxic_metabolite_accumulation | pass |
| Azathioprine + allopurinol + TPMT/NUDT15 PM | 4 | 2 | exposure_increase_toxicity, toxic_metabolite_accumulation | pass |
| G6PD oxidant stack | 5 | 1 | risk_marker_context | pass |
| Succinylcholine + BCHE/RYR1 context | 5 | 3 | risk_marker_context, risk_marker_context, exposure_increase_toxicity | pass |
| Warfarin + ibuprofen | 1 | 1 | exposure_increase_toxicity | pass |
| Haloperidol + azithromycin + methadone | 11 | 4 | exposure_increase_toxicity, washout_or_persistence, washout_or_persistence, washout_or_persistence | pass |
| Sertraline + linezolid | 5 | 3 | exposure_increase_toxicity, washout_or_persistence, washout_or_persistence | pass |
| Diazepam + morphine | 2 | 2 | exposure_increase_toxicity, washout_or_persistence | pass |
| Fluoxetine + paroxetine washout | 16 | 3 | exposure_increase_toxicity, washout_or_persistence, washout_or_persistence | pass |
