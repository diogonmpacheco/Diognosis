...
This is the first completed Diognosis data-review batch for Open Targets/ClinPGx context. These Open Targets rows are linked to existing Diognosis evidence references, but the imported context remains non-scoring and without professional sign-off.
